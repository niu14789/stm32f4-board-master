...
static void LCD_CtrlLinesConfig(void)
{
	...
	/* 使能 GPIO时钟 */
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD |RCC_AHB1Periph_GPIOB| RCC_AHB1Periph_GPIOE | RCC_AHB1Periph_GPIOG|RCC_AHB1Periph_GPIOF, ENABLE);
...
static void LCD_FSMCConfig(void)
{
	...
	timingWrite.FSMC_AddressSetupTime = 0xf;
	...
	timingRead.FSMC_AddressSetupTime =0xf;
...
0	
	...
	LCD_DispStr(x,y,(char *)tbuf,&__FONT);
}
