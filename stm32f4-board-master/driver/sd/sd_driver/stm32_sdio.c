...
int SD_Init_User(void)
{
	  ...
	  NVIC_InitTypeDef NVIC_InitStructure1;
		...
		if(SD_Init() != 0)
		{
			 return 1; //init error please check it
		}
	#ifdef SD_DMA_MODE
		
		 NVIC_InitStructure1.NVIC_IRQChannel = SDIO_IRQn;
		 NVIC_InitStructure1.NVIC_IRQChannelPreemptionPriority = 0;
		 NVIC_InitStructure1.NVIC_IRQChannelSubPriority = 0;
		 NVIC_InitStructure1.NVIC_IRQChannelCmd = ENABLE;
		 NVIC_Init(&NVIC_InitStructure1);
		// DMA2 STREAMx Interrupt ENABLE
		 NVIC_InitStructure1.NVIC_IRQChannel = SD_SDIO_DMA_IRQn;
